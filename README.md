...
- [อ่านไฟล์ไหนดี](#อ่านไฟล์ไหนดี) · [ติดตั้งลงโปรเจกต์](#ติดตั้งลงโปรเจกต์)
- [Claude จะถามอะไรคุณ](#claude-จะถามอะไรคุณ) · [จังหวะที่คนต้องลงมือเอง](#จังหวะที่คนต้องลงมือเอง) · [สิ่งที่ skill นี้จะไม่ทำ](#สิ่งที่-skill-นี้จะไม่ทำ)
- [โครงสร้าง](#โครงสร้าง) · [เช็คว่าเครื่องพร้อม](#เช็คว่าเครื่องพร้อม) · [ข้อจำกัดที่ต้องรู้](#ข้อจำกัดที่ต้องรู้) · [แก้ skill](#แก้-skill)
